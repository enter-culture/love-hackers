...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-BQ7_3jv7.js");
...
const manifest = {
  "592ee318729f784624985e5ab0621d8fac0783a4dfe02d222b0ec74360a796bc": {
    functionName: "analyzePhotoFn_createServerFn_handler",
    importer: () => import("./assets/ai.functions-BZjexcsF.js")
  },
  "862e530c4855f868d7dc1c0ec0438f883e138c48c7b0ec3d51a7b179f1874d3f": {
    functionName: "chatPracticeFn_createServerFn_handler",
    importer: () => import("./assets/ai.functions-BZjexcsF.js")
  },
  "707efd470f463faca7bd6dbe9bc2b4062f1a4f5936b1ea1f3dd2cebd933c2a58": {
    functionName: "recommendPlacesFn_createServerFn_handler",
    importer: () => import("./assets/ai.functions-BZjexcsF.js")
  },
  "f1c25d7cdc675b1925bfb8621637ee64d86a50f3372e50057c2fc995f07ee4a9": {
    functionName: "recommendLookFn_createServerFn_handler",
    importer: () => import("./assets/ai.functions-BZjexcsF.js")
  },
  "49337e41df04ef585d2e754016b90c49562c4ad303fc234a35c2f206b6760e25": {
    functionName: "generateQuestionFn_createServerFn_handler",
    importer: () => import("./assets/game.functions-Dscyvuuf.js")
  },
  "b947934d47cd79f7ed79062e556df019f56e53fb949bd5171c4ada3eabdab3c8": {
    functionName: "generateReactionFn_createServerFn_handler",
    importer: () => import("./assets/game.functions-Dscyvuuf.js")
  },
  "d30ff2461a3f36dc8a025c9203bb04b73f646b645d029a9e7c0b3d5f5226f127": {
    functionName: "generateResultFn_createServerFn_handler",
    importer: () => import("./assets/game.functions-Dscyvuuf.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-DMY8zKtu.js").then((n) => n.r),
    import("./assets/start-BrzV50gx.js"),
